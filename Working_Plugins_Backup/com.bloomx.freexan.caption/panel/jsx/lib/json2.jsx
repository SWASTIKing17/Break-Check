/**
 * JSON2.js Polyfill for ExtendScript
 * Adobe apps use an older version of JavaScript that doesn't include JSON support.
 * This file adds JSON.stringify and JSON.parse.
 */
